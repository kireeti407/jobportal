...
function HeroSection() {
  ...
  return (
    <div className="text-center" id="header">
        ...
        <span className="mx-auto px-4 py-2 rounded-full  bg-gray-100 text-blue-500 text-sm sm:text-xl font-medium">The Ultimate Destination for Blue-Collar and IT Jobs.</span>
        <h1 className="sm:text-4xl md:text-5xl text-3xl font-bold text-[#526a6e]"><span className="text-blue-500">All-in-One Employment Hub:</span></h1>
